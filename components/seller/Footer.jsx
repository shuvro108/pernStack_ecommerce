...
const Footer = () => {
  return (
    <div className="flex md:flex-row flex-col-reverse items-center justify-between text-left w-full px-8">
      <div className="flex items-center gap-4">
        ...
        <p className="py-3 text-center text-xs md:text-sm text-gray-500">
          Copyright 2025 © https://github.com/shuvro108 All Right Reserved.
        </p>
      </div>
